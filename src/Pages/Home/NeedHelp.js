...
const NeedHelp = () => {
  ...
  return (
    <div className="mx-8 mb-32">
      <div class="card bg-red-100 pt-8">
        <h1 className="text-red-600 text-center text-3xl">Need Help?</h1>
        <div class="card-body grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 px-8 align-center">
          {services.map((service) => (
            ...
            >
              ...
              <h2 class="text-center text-xl font-semibold text-red-600 mt-5">
                {service.name}
              </h2>
            </Link>
          ))}
